...
## Project Structure
    ...
    ├── kak_elly_dilivery_32870  # Django project configurations
...
1. Clone this repo and `cd kak_elly_dilivery_32870`
...
2. Clone this repo and `cd kak_elly_dilivery_32870`
